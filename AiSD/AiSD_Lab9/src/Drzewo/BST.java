...
public class BST {
    ...
    public void wartoscWyrazenia() {
        System.out.println("Wartość wyrażenia zapisanego w drzewie wynosi: " + obliczenie(root));
    }

    public void wyswietlInfiks() {
        System.out.print("Wyrażenie w postaci infiksowej : ");
        inorder(root);
    ...
    public void liczbaLisci() {
        System.out.println("Liczba liści: " + liscie(root));
    }
    ...
    {
        System.out.println("Liczba węzłów: " + wezly(root));
    }
    ...
    public void wysokoscDrzewa(){
        System.out.println("Wysokość: " + wysokosc(root));
    }
